...
import com.springboot.demo.domian.User;
...
public class DemoApplicationTests {
	...
	public void topicPublisher() {
		// 1、只发送邮件订阅用户消息
		// rabbitTemplate.convertAndSend("topic_exchange","info.email","topics send
		// email message");
		// 2、只发送短信订阅用户消息
		// rabbitTemplate.convertAndSend("topic_exchange","info.sms","topics send sms
		// message");
		// 3、发送同时订阅邮件和短信的用户消息
